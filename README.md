...
| Closed forests | [ONF](https://www.onf.fr/) public-forests feature service | The 3 state forests closed in full |
...
python scripts/build_closures.py  # -> data/closures.geojson
```
...
`build_closures.py` pulls the boundaries of the three closed state forests from
the ONF's open feature service. It simplifies them and drops detached parcels
under 4 ha — 0.56% of the closed area, which the legend notes.
...
- Closed-forest boundaries © [ONF](https://www.onf.fr/)
